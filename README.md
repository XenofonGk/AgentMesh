...
(see [`agentmesh/SECURITY.md`](agentmesh/SECURITY.md)).

> **Status: Phase 0 — foundations.** The monorepo, toolchain, and Compose stack are in
> place; the app itself is intentionally empty. See [`agentmesh/PLAN.md`](agentmesh/PLAN.md)
...
MIT — see [`agentmesh/LICENSE`](agentmesh/LICENSE).
