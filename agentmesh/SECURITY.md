...
| Layer     | Control                                                                                                                                                                                             |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Vault     | AES-256-GCM envelope encryption; master key from env or KMS, never in the DB or the repo; per-user data-encryption key; ciphertext stored as `{provider, user_id, ciphertext, iv, tag, created_at}` |
